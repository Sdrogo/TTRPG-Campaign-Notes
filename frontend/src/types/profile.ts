// How a user is shown to others: every response that names a user carries
// these fields (backend app/api/profiles.py). All optional - a user who
// never opened the Account page is shown by email.
